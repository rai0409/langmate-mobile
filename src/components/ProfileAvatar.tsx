...
export function ProfileAvatar({ profile, name, photoURL, size = 48 }: ProfileAvatarProps) {
  ...
  return (
    <View style={[styles.avatar, styles.fallback, { width: size, height: size, borderRadius }]}>
